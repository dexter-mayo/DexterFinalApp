...
class BODYTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let arbonne = bodyInfo(
            name: "Arbonne",
            text: "PETA certified no-cruelty and vegan brand. They sell skincare for the body and the face. Arbonne also sells haircare, vitamins, and makeup.",
            pic: "arbonne"
        )
        body.append(arbonne)
        ...
        let beauty = bodyInfo(
            ...
            text: "PETA certified no-cruelty and vegan beauty brand. They sell everything from makeup to nail polish, and don't test on any animals.",
            pic: "bwc"
        )
        body.append(beauty)
        ...
        let eco = bodyInfo(
            name: "EcoTools",
            text: "PETA certified no-cruelty and vegan brand that specializes in making makeup tools and brushes.",
            pic: "eco"
        )
        body.append(eco)
        ...
        let fox = bodyInfo(
            ...
            text: "PETA certified no-cruelty and vegan body and face skincare brand.",
            pic: "fox"
        )
        body.append(fox)
